...
class Test_SearchCustomerRoleGuests_025:
    ...
    def test_searchcustomerrole_guests(self,setup):
        self.logger.info("*****SearchCustomer_Role_Guests_024*****")
        self.driver = setup
        ...
        self.logger.info("********Starting_SearchGuest_Role_024******")
        ...
        self.onlinecustomer.selectCustomerRole("Guests")
        ...
        for customer_name in search_customer_names:
            assert customer_name in normal_customer_names,(
                ...
                f"Guests search results was not found "
