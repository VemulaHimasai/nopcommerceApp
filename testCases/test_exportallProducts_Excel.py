...
class Test_ExportAllProducts_Excel_048:
    ...
    def test_export_all_products_excel(self, setup):

        self.logger.info(
            "******* Exporting All Products to Excel *******"
        )
        ...
        searchproduct.clickExportAllExcel()
        ...
        self.logger.info(
            "******* All Products Excel Export Passed *******"
        )
