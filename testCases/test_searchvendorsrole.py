...
class Test_SearchCustomerRoleVendors_025:
    ...
    def test_searchcustomerrole_vendors(self,setup):
        ...
        self.logger.info("********Starting_SearchVendor_Role_025******")
        ...
        self.onlinecustomer.selectCustomerRole("Vendors")
        ...
        for customer_name in search_customer_names:
            assert customer_name in normal_customer_names,(
                ...
                f"Vendor search results was not found "
