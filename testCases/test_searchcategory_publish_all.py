...
class Test_SearchCategoryPublish_All_052:
    ...
    def test_searchcategorypyblish_all(self, setup):

        self.logger.info(
            "***** Test_SearchCategoryPublish_All_052 *****"
        )
        ...
        self.searchcategory.selectPublishedItem("All")
